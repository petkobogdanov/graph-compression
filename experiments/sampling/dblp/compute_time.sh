...
echo "data	ST	STUS_SLOW	STBS_SLOW	STBS_FAST" >> $results_time.dat
...
do
  ...
  avg_stus_slow=`echo "scale=10; $avg_stus_slow/$num_runs_sampling" | bc`

  echo "$f	$avg_st	$avg_stus_slow	$avg_stbs_slow	$avg_stbs_fast" >> $results_time.dat
done
