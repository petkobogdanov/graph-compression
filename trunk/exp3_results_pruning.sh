...
rm avg_pruning.dat
echo "X STUS_1 STUS_2 STBS_1 STBS_2" >> avg_pruning.dat
for u in ${radius[@]}
do
  ...
  echo "$u $avg_rate_pruned_1_stus $avg_rate_pruned_2_stus $avg_rate_pruned_1_stbs $avg_rate_pruned_2_stbs" >> avg_pruning.dat
done
